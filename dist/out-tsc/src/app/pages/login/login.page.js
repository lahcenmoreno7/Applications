...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, authService, message, storage, router) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.message.presentLoading("Cargando")];
                    case 1:
                        loading = _a.sent();
                        return [4 /*yield*/, loading.present()];
                    case 2:
                        _a.sent();
                        userData = { "username": this.loginControl.value, "password": this.passwordControl.value };
                        this.authService.login(userData, 'login').then(function (result) {
                            loading.dismiss();
                            _this.responseData = result;
                            if (_this.responseData.success) {
                                _this.storage.set("token", _this.responseData.token);
                                _this.navCtrl.navigateRoot('/home-results');
                            }
                            else {
                                _this.message.presentToast("Login y/o contraseña incorrectos", 5000);
                            }
                            ...
                            console.error(error);
                            loading.dismiss();
                            _this.message.presentToast("Authentication failed ", 5000);
                        });
                        return [2 /*return*/];
                }
            });
